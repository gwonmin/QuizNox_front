...
import BedrockOverviewMdx from "./mdx/aws-common/BedrockOverview.mdx";
import BedrockAgentMdx from "./mdx/aws-common/BedrockAgent.mdx";
...
import DataWarehouseMdx from "./mdx/core-cs/DataWarehouse.mdx";
...
import MlopsMdx from "./mdx/core-cs/Mlops.mdx";
...
import LoadTestingMdx from "./mdx/core-cs/LoadTesting.mdx";
import AiopsMdx from "./mdx/core-cs/Aiops.mdx";
...
const HandbookView = memo(function HandbookView() {
  ...
  const isMdxDoc = (() => {
    ...
    if (layerId === "core-cs" && slug === "mlops") return true;
    ...
    if (layerId === "core-cs" && slug === "load-testing") return true;
    if (layerId === "core-cs" && slug === "aiops") return true;
    ...
    if (layerId === "core-cs" && slug === "data-warehouse") return true;
    ...
    if (layerId === "aws-common" && slug === "bedrock-overview") return true;
    if (layerId === "aws-common" && slug === "bedrock-agent") return true;
  ...
  const mdxComponent = (() => {
    ...
    if (layerId === "core-cs" && slug === "mlops") return <MlopsMdx />;
    ...
    if (layerId === "core-cs" && slug === "load-testing") return <LoadTestingMdx />;
    if (layerId === "core-cs" && slug === "aiops") return <AiopsMdx />;
    ...
    if (layerId === "core-cs" && slug === "data-warehouse") return <DataWarehouseMdx />;
    ...
    if (layerId === "aws-common" && slug === "bedrock-overview") return <BedrockOverviewMdx />;
    if (layerId === "aws-common" && slug === "bedrock-agent") return <BedrockAgentMdx />;
